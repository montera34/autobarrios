	...
	function pexeto_load_meta_boxes() {
		...
		$pexeto->meta = array(
			...
			'page'=> array(
				...
				array(
					'name' => 'Show category filter in header',
					'id' => PEXETO_META_PREFIX.'blog_show_filter',
					'type' => 'checkbox',
					'std' => 'false',
					'description' => 'If enabled, a category filter will be displayed in the blog page header',
					'data' => array( 'template' => 'template-blog.php' )
				),
